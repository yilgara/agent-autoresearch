...
Defaults to `False` on ambiguity — burden of proof is on the new skill.

This is strategy v2's implementation. See `prompts/judge.md` next to
...
from agent_autoresearch.strategies.v2._common import extract_tag
